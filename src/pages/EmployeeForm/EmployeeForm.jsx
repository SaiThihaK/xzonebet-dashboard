...
const EmployeeForm = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      formdata.append("work_histories",  JSON.stringify(arrOfObj1));
      formdata.append("educations", JSON.stringify(arrOfObj2));
  ...
  const logoChange = (e) => { console.log(e.target.files); setlogo(URL.createObjectURL(e.target.files)) }
