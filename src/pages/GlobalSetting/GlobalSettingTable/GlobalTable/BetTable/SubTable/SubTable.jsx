  ...
  return (
    ...
    <div className="sub-table">
            ...
            {data.map((el)=>{
              ...
              return(<TableRow team1={el.localTeam.data.name} team2={el.visitorTeam.data.name} duration={el.time.starting_at.date} half={el.time.starting_at.time} odd={el.odds.data} /> )
            })}
